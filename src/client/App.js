...
export default class App extends Component {
  ...
  init() {
    ...
    const trigger = menu.querySelector('.bt-menu-trigger a');
    // triggerPlay only for demo 6
    const triggerPlay = document.querySelector('a.bt-menu-trigger-out');
    // event type (if mobile use touch events)
    const eventtype = this.mobilecheck() ? 'touchstart' : 'click';
        ...
        <div className="wrapper" id="wrapper">
          <nav id="bt-menu" className="bt-menu bt-menu-close">
            <div className="bt-menu-trigger">
              <a className="link link--logo" href="#">
                JD
                <span data-letters="JD" />
                <span data-letters="JD" />
              </a>
            </div>
            ...
            <ul>
              <li>
                <a href="#" className="bt-icon icon-user-outline">
                  About Me
                </a>
              </li>
              <li>
                <a href="#" className="bt-icon icon-sun">
                  Work
                </a>
              </li>
              <li>
                <a href="#" className="bt-icon icon-windows">
                  Clients
                </a>
              </li>
              <li>
                <a href="#" className="bt-icon icon-speaker">
                  Blog
                </a>
              </li>
              <li>
                <a href="#" className="bt-icon icon-bubble">
                  Contact
                </a>
              </li>
            </ul>
